...
**Doc export tương tự:** `[task-export-danh-sach-de-xuat-chu-truong-chuyen-tiep.md](../de-xuat-chuyen-tiep/export.md)`
...
| `docs/issues/de-xuat-chuyen-tiep/export.md` | Doc export cùng pattern             |
