...
- Design template-driven: doc này (đã gộp design template-driven)

**Liên quan:** [task-export-excel-ban-giao-ho-so.md](../ban-giao-ho-so/export-excel.md), [task-export-excel-noi-dung-da-ky.md](../9460/export-excel-noi-dung-da-ky.md)
