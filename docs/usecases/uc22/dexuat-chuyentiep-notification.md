...
**Review gate:** Xác nhận design (đặc biệt chọn Approach A + extend `IDapperRepository`) trước khi chạy implementation plan tại `(đã gỡ — design giữ tại docs/usecases/uc22/dexuat-chuyentiep-notification.md)`.
