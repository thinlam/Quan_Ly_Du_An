...
public class ToTrinhKeHoachConfiguration : AggregateRootConfiguration<ToTrinhKeHoach> {
    public override void Configure(EntityTypeBuilder<ToTrinhKeHoach> builder) {
        builder.ToTable(nameof(ToTrinhKeHoach));
