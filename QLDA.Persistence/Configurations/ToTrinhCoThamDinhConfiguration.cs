...
public class ToTrinhCoThamDinhConfiguration : AggregateRootConfiguration<ToTrinhCoThamDinh> {
    public override void Configure(EntityTypeBuilder<ToTrinhCoThamDinh> builder) {
        builder.ToTable(nameof(ToTrinhCoThamDinh));
        ...
        builder.Property(x => x.TrichYeu)
            .HasMaxLength(4000);
        builder.Property(x => x.KetQuaThamTra)
             .HasMaxLength(4000);

        builder.Property(x => x.KetQuaThamDinh)
            .HasMaxLength(4000);
