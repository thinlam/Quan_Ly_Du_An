...
public class ToTrinhThamDinhNhaThauConfiguration : AggregateRootConfiguration<ToTrinhKetQuaGoiThau> {
    public override void Configure(EntityTypeBuilder<ToTrinhKetQuaGoiThau> builder) {
        builder.ToTable(nameof(ToTrinhKetQuaGoiThau));
