...
internal class DuToanDauTuTrinhCommandHandler : IRequestHandler<DuToanDauTuTrinhCommand, int> {
    ...
    public DuToanDauTuTrinhCommandHandler(IServiceProvider serviceProvider) {
    ...
    public async Task<int> Handle(DuToanDauTuTrinhCommand request, CancellationToken cancellationToken) {
        ...
        ManagedException.ThrowIfNull(entity, "Không tìm thấy dữ liệu muốn trình.");
