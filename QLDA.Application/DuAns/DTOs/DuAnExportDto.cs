...
/// <summary>
/// Dòng dữ liệu export Excel danh sách dự án — JsonPropertyName khớp placeholder template DanhSachDuAn.xlsx
/// (camelCase: $stt, $maDuAn, $tenDuAn, $thoiGianKhoiCong, $lanhDaoPhuTrachId, $donViPhuTrachChinhId,
///  $donViPhoiHopIds, $hinhThucDauTuId, $hinhThucQuanLyDuAnId, $tongMucDauTu).
/// </summary>
