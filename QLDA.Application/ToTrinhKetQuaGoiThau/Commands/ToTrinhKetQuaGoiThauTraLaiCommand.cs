...
/// </summary>
public record ToTrinhKetQuaGoiThauTraLaiCommand(Guid Id, string NoiDung) : IRequest<int>;

internal class ToTrinhKetQuaGoiThauTraLaiCommandHandler : IRequestHandler<ToTrinhKetQuaGoiThauTraLaiCommand, int> {
    ...
    public ToTrinhKetQuaGoiThauTraLaiCommandHandler(IServiceProvider serviceProvider) {
