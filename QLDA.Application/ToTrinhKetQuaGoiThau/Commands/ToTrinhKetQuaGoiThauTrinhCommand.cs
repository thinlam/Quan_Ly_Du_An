...
/// </summary>
public record ToTrinhKetQuaGoiThauTrinhCommand(Guid Id, string? NoiDung = null) : IRequest<int>;

internal class ToTrinhKetQuaGoiThauTrinhCommandHandler : IRequestHandler<ToTrinhKetQuaGoiThauTrinhCommand, int>
{
    private readonly IRepository<ToTrinhKetQuaGoiThau, Guid> _repository;
    private readonly IRepository<PheDuyetHistory, Guid> _historyRepository;
    private readonly IRepository<DanhMucTrangThaiPheDuyet, int> _statusRepository;
    private readonly IUserProvider _userProvider;
    private readonly IUnitOfWork _unitOfWork;

    public ToTrinhKetQuaGoiThauTrinhCommandHandler(IServiceProvider serviceProvider)
    {
        _repository = serviceProvider.GetRequiredService<IRepository<ToTrinhKetQuaGoiThau, Guid>>();
    ...
    public async Task<int> Handle(ToTrinhKetQuaGoiThauTrinhCommand request, CancellationToken cancellationToken)
    {
