...
/// </summary>
public record ThuyetMinhDuAnDuyetCommand(Guid Id) : IRequest<int>;

internal class ThuyetMinhDuAnDuyetCommandHandler : IRequestHandler<ThuyetMinhDuAnDuyetCommand, int> {
    ...
    public ThuyetMinhDuAnDuyetCommandHandler(IServiceProvider serviceProvider) {
