...
/// </summary>
public record ThuyetMinhDuAnTraLaiCommand(Guid Id, string NoiDung) : IRequest<int>;

internal class ThuyetMinhDuAnTraLaiCommandHandler : IRequestHandler<ThuyetMinhDuAnTraLaiCommand, int> {
    private readonly IRepository<Domain.Entities.ThuyetMinhDuAn, Guid> _repository;
    ...
    public ThuyetMinhDuAnTraLaiCommandHandler(IServiceProvider serviceProvider) {
        _repository = serviceProvider.GetRequiredService<IRepository<Domain.Entities.ThuyetMinhDuAn, Guid>>();
    ...
    public async Task<int> Handle(ThuyetMinhDuAnTraLaiCommand request, CancellationToken cancellationToken) {
