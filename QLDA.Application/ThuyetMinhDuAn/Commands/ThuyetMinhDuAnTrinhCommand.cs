...
///
/// </summary>
public record ThuyetMinhDuAnTrinhCommand(Guid Id, string? NoiDung = null) : IRequest<int>;

internal class ThuyetMinhDuAnTrinhCommandHandler : IRequestHandler<ThuyetMinhDuAnTrinhCommand, int>
{
    private readonly IRepository<ThuyetMinhDuAn, Guid> _repository;
    private readonly IRepository<PheDuyetHistory, Guid> _historyRepository;
    private readonly IRepository<DanhMucTrangThaiPheDuyet, int> _statusRepository;
    private readonly IUserProvider _userProvider;
    private readonly IUnitOfWork _unitOfWork;

    public ThuyetMinhDuAnTrinhCommandHandler(IServiceProvider serviceProvider)
    {
        _repository = serviceProvider.GetRequiredService<IRepository<ThuyetMinhDuAn, Guid>>();
    ...
    public async Task<int> Handle(ThuyetMinhDuAnTrinhCommand request, CancellationToken cancellationToken)
    {
       ...
       // entity.NgayTrinh = DateTime.UtcNow;
        ...
        var history = new PheDuyetHistory
        {
            ...
            NoiDung = $"Số {entity.So ?? ""} " +
                      $" - ngày {entity.NgayTrinh.ToDateOnlyVn().ToString("dd/MM/yyyy")}"+
