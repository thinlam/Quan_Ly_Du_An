...
/// </summary>
public record KeHoachTrienKhaiHangMucDuyetCommand(Guid Id) : IRequest<int>;

internal class KeHoachTrienKhaiHangMucDuyetCommandHandler : IRequestHandler<KeHoachTrienKhaiHangMucDuyetCommand, int> {
    ...
    public KeHoachTrienKhaiHangMucDuyetCommandHandler(IServiceProvider serviceProvider) {
    ...
    public async Task<int> Handle(KeHoachTrienKhaiHangMucDuyetCommand request, CancellationToken cancellationToken) {
