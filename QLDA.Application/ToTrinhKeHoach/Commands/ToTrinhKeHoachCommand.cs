...
/// </summary>
public record ToTrinhKeHoachCommand(Guid Id, string? NoiDung = null) : IRequest<int>;

internal class ToTrinhKeHoachCommandHandler : IRequestHandler<ToTrinhKeHoachCommand, int> {
    private readonly IRepository<Domain.Entities.ToTrinhKeHoach, Guid> _repository;
    private readonly IRepository<PheDuyetHistory, Guid> _historyRepository;
    private readonly IRepository<DanhMucTrangThaiPheDuyet, int> _statusRepository;
    private readonly IUserProvider _userProvider;
    private readonly IUnitOfWork _unitOfWork;

    public ToTrinhKeHoachCommandHandler(IServiceProvider serviceProvider) {
    ...
    public async Task<int> Handle(ToTrinhKeHoachCommand request, CancellationToken cancellationToken) {
