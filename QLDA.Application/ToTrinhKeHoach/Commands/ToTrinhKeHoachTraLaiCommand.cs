...
/// </summary>
public record ToTrinhKeHoachTraLaiCommand(Guid Id, string NoiDung) : IRequest<int>;

internal class ToTrinhKeHoachTraLaiCommandHandler : IRequestHandler<ToTrinhKeHoachTraLaiCommand, int> {
