...
/// </summary>
public record TrienKhaiKeHoachLCNTTraLaiCommand(Guid Id, string NoiDung) : IRequest<int>;

internal class TrienKhaiKeHoachLCNTTraLaiCommandHandler : IRequestHandler<TrienKhaiKeHoachLCNTTraLaiCommand, int> {
    ...
    public TrienKhaiKeHoachLCNTTraLaiCommandHandler(IServiceProvider serviceProvider) {
    ...
    public async Task<int> Handle(TrienKhaiKeHoachLCNTTraLaiCommand request, CancellationToken cancellationToken) {
